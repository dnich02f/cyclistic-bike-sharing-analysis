...
Ask SMART Questions to develop business task:
...
* Download data and store it appropriately - Files were originally contained in zip files, then saved as .csv files.
* Identity how the data is organized - Data is organized into long data.
...
* Choose tools for cleaning - using R because it can handle large amounts of data in files.
...
Since there were negative values for ride_length calculated field, it is assumed that the data was entered in the wrong column. I used the ABS() function in Tableau to correct the assumed error. 
There are also many ride_lengths that are for 00:00:00. For these values, it is noted that the start and end station name are the same, or non existent. It is assumed that these riders chose not to ride.


#### 3.1 Importing data into RStudio and Cleaning with R
...
#=================================================
# EXPORT CSV FILE FOR FURTHER ANALYSIS IN TABLEAU
#=================================================
# Create a csv file
